...
/* Ensure stdint, stdlib and etc. is only used by the compiler,
...
/* Heap_5 is used: it useless option (before heap size for 4 HTTP ) */
//#define configTOTAL_HEAP_SIZE					((size_t) (54 * 1024))
#define configUSE_CCRAM_FOR_HEAP 				1
...
#ifdef DEBUG
	#define FreeRTOS_debug_printf( MSG ) 		do{} while(0)// trace_printf MSG
    #define FreeRTOS_printf( MSG ) 				do{} while(0)// trace_printf MSG
